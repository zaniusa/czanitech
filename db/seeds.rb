...
Pymt.create(order_to_show: 3, pymt_status: "Please, Pay $50. Thank You!", is_requesting_pymt: true)
Pymt.create(order_to_show: 4, pymt_status: "Please, Pay $20. Thank You!", is_requesting_pymt: true)
Pymt.create(order_to_show: 5, pymt_status: "Please, Pay $10. Thank You!", is_requesting_pymt: true)
